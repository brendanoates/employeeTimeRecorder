    ...
    operations = [
        migrations.CreateModel(
                ...
                fields=[
                    ...
                    ('staff_number', models.CharField(blank=True, default='', max_length=10, null=True)),
                    ('manager_email', models.CharField(blank=True, default='', max_length=30, null=True)),
